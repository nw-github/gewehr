...
bool Offsets::scan_netvars(const Memory& mem, DWORD dwGetAllClasses) {
    ...
    m_fFlags               = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_CSPlayer")            , xorstr("m_fFlags"));
    m_iCrosshairId         = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_CSPlayer")            , xorstr("m_bHasDefuser")) + 92;
    m_iGlowIndex           = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_CSPlayer")            , xorstr("m_flFlashDuration")) + 24;
    m_iShotsFired          = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_CSPlayer")            , xorstr("m_iShotsFired"));
    m_vecViewOffset        = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_CSPlayer")            , xorstr("m_vecViewOffset[0]"));
    m_bGunGameImmunity     = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_CSPlayer")            , xorstr("m_bGunGameImmunity"));
    m_vecVelocity          = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_CSPlayer")            , xorstr("m_vecVelocity[0]"));
    m_iFOV                 = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_CSPlayer")            , xorstr("m_iFOV"));
    m_bIsScoped            = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_CSPlayer")            , xorstr("m_bIsScoped"));
    m_iTeamNum             = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BasePlayer")          , xorstr("m_iTeamNum"));
    m_iHealth              = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BasePlayer")          , xorstr("m_iHealth"));
    m_hViewModel           = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BasePlayer")          , xorstr("m_hViewModel[0]"));
    m_aimPunchAngle        = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BasePlayer")          , xorstr("m_aimPunchAngle"));
    m_vecOrigin            = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BasePlayer")          , xorstr("m_vecOrigin"));
    m_iViewModelIndex      = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BaseCombatWeapon")    , xorstr("m_iViewModelIndex"));
    m_flFallbackWear       = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BaseAttributableItem"), xorstr("m_flFallbackWear"));
    m_nFallbackPaintKit    = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BaseAttributableItem"), xorstr("m_nFallbackPaintKit"));
    m_iItemIDHigh          = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BaseAttributableItem"), xorstr("m_iItemIDHigh"));
    m_iEntityQuality       = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BaseAttributableItem"), xorstr("m_iEntityQuality"));
    m_iItemDefinitionIndex = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BaseAttributableItem"), xorstr("m_iItemDefinitionIndex"));
    m_hActiveWeapon        = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BaseCombatCharacter") , xorstr("m_hActiveWeapon"));
    m_hMyWeapons           = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BaseCombatCharacter") , xorstr("m_hMyWeapons"));
    m_nModelIndex          = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BaseViewModel")       , xorstr("m_nModelIndex"));
    m_dwBoneMatrix         = utl::find_netvar(mem, dwGetAllClasses, xorstr("DT_BaseAnimating")       , xorstr("m_nForceBone")) + 28;
